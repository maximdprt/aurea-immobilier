...
-- Conseillers --------------------------------------------------------------
insert into public.agents (slug, name, role, email, phone, photo_file, legacy_id) values ('helene-vermeire-benz', 'Hélène Vermeire Benz', 'Directrice, présidente', 'helene.vermeire@aurea-immobilier.fr', '06 33 63 02 55', 'helene-vermeire-benz-839239.jpg', '839239') on conflict (slug) do update set name = excluded.name, role = excluded.role, email = excluded.email, phone = excluded.phone, photo_file = excluded.photo_file;
insert into public.agents (slug, name, role, email, phone, photo_file, legacy_id) values ('vincent-maume', 'Vincent Maume', 'Directeur associé, cofondateur', 'vincent.maume@aurea-immobilier.fr', '06 83 70 66 01', 'vincent-maume-839238.jpg', '839238') on conflict (slug) do update set name = excluded.name, role = excluded.role, email = excluded.email, phone = excluded.phone, photo_file = excluded.photo_file;
insert into public.agents (slug, name, role, email, phone, photo_file, legacy_id) values ('oriane-cherel', 'Oriane Cherel', 'Négociatrice', 'oriane.cherel@aurea-immobilier.fr', '06 99 39 88 48', 'oriane-cherel-840371.jpg', '840371') on conflict (slug) do update set name = excluded.name, role = excluded.role, email = excluded.email, phone = excluded.phone, photo_file = excluded.photo_file;
insert into public.agents (slug, name, role, email, phone, photo_file, legacy_id) values ('aimee-vaillant', 'Aimée Vaillant', 'Négociatrice', 'aimee.vaillant@aurea-immobilier.fr', '06 28 46 57 71', 'aimee-vaillant-847433.jpg', '847433') on conflict (slug) do update set name = excluded.name, role = excluded.role, email = excluded.email, phone = excluded.phone, photo_file = excluded.photo_file;
insert into public.agents (slug, name, role, email, phone, photo_file, legacy_id) values ('justine-vitry', 'Justine Vitry', 'Négociatrice', null, '06 10 96 01 31', 'justine-vitry-839272.jpg', '839272') on conflict (slug) do update set name = excluded.name, role = excluded.role, email = excluded.email, phone = excluded.phone, photo_file = excluded.photo_file;
insert into public.agents (slug, name, role, email, phone, photo_file, legacy_id) values ('natacha-laly', 'Natacha Laly', 'Négociatrice', null, '06 73 71 23 89', 'natacha-laly-natacha-laly.jpeg', '839273') on conflict (slug) do update set name = excluded.name, role = excluded.role, email = excluded.email, phone = excluded.phone, photo_file = excluded.photo_file;
insert into public.agents (slug, name, role, email, phone, photo_file, legacy_id) values ('jill-thepaut', 'Jill Thepaut', 'Négociatrice', null, '06 73 26 93 38', 'jill-thepaut-jill.jpg', '869668') on conflict (slug) do update set name = excluded.name, role = excluded.role, email = excluded.email, phone = excluded.phone, photo_file = excluded.photo_file;
insert into public.agents (slug, name, role, email, phone, photo_file, legacy_id) values ('evan-fernandes', 'Evan Fernandes', 'Négociateur', 'evan.fernandes@aurea-immobilier.fr', '06 68 42 59 73', 'evan-fernandes-839241.jpg', '839241') on conflict (slug) do update set name = excluded.name, role = excluded.role, email = excluded.email, phone = excluded.phone, photo_file = excluded.photo_file;
insert into public.agents (slug, name, role, email, phone, photo_file, legacy_id) values ('marion-nicaise', 'Marion Nicaise', 'Gestionnaire locative', 'marion.nicaise@aurea-immobilier.fr', '06 24 71 07 39', 'marion-nicaise-marion.jpg', null) on conflict (slug) do update set name = excluded.name, role = excluded.role, email = excluded.email, phone = excluded.phone, photo_file = excluded.photo_file;
